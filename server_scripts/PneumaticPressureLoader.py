...
#load stopper stuff
sensor_sans = LabJackSensor(port_to_read='AIN0',reset_pin='DIO6')
load_stopper_sans = LoadStopperDriver(sensor_sans,data=data,auto_initialize=False,sensorlabel='afterSANS')

sensor_spec = LabJackSensor(port_to_read='AIN1',reset_pin='DIO7')
load_stopper_spec = LoadStopperDriver(sensor_spec,data=data,auto_initialize=False,sensorlabel='afterSPEC')
