...
from AFL.automation.sample.USAXS_LoaderV2_SampleDriver import USAXS_LoaderV2_SampleDriver


driver =USAXS_LoaderV2_SampleDriver(
        load_url='piloader:5000',
        prep_url='piot2:5000',
        sas_url='localhost:5000',
        sensor_url='localhost:5051',
        camera_urls = [],
        )
server = APIServer('USAXS_SampleServer')
