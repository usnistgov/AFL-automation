...
pump1 = NE1kSyringePump('/dev/ttySyrPmp0',26.72,10,baud=19200,pumpid=10) # ID for 10mL = 14.859, for 50 mL 26.43
pump2 = NE1kSyringePump('/dev/ttySyrPmp0',26.72,10,baud=19200,pumpid=11,daisy_chain=pump1) # ID for 10mL = 14.859, for 50 mL 26.43

protocol = PushPullSelectorSampleCell(pump1,
                                      selector1,
                                      catch_to_sel_vol      =Tubing(1517,61).volume(),
                                      cell_to_sel_vol       =Tubing(1517,122).volume(),
...
protocol2 = PushPullSelectorSampleCell(pump2,
                                      ...
                                      cell_to_sel_vol       =Tubing(1517,91.4).volume(),
                                      syringe_to_sel_vol    =None,
                                      selector_internal_vol =None,
                                     )
