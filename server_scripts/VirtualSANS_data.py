...
from AFL.automation.Virtual_SAS_data import Virtual_SAS_data
from AFL.automation.APIServer.data.DataTiled import DataTiled

### add local tiled server here
...
server = APIServer('VirtualSANS_Data_Server')
...
model_ds = xr.load_datasaet(ds_path)
server.create_queue(Virtual_SAS_data(name='VirtualSANS_Data',dataset=model_ds))
